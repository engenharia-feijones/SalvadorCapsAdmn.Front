      ...
      <v-container>
        <v-row justify="center" align="center">
          <v-col class="mb-0 pb-0" cols="12" sm="6" md="12">
            <v-text-field v-model="brand.name" label="Nome"> </v-text-field>
          </v-col>
                ...
                <v-col cols="3">
                  <v-card elevation="0">
                    <v-img
                      ...
                      max-height="70px"
                      max-width="70px"
                      :src="brand.desktopSpotlightImage"
                    ></v-img>
                  </v-card>
                </v-col>
                <v-col align="start" cols="6">
                  <p style="font-size: 10px" v-if="brand.name">
                    {{ brand.desktopSpotlightImage }}
                  </p>
                </v-col>
                <v-col class="btnX" align="end" cols="1">
                  <v-btn v-if="brand.desktopSpotlightImage" text fab small>
                ...
                <v-col cols="3">
                  <v-card elevation="0">
                    <v-img
                      ...
                      max-height="70"
                      max-width="70"
                      :src="brand.mobileSpotlightImage"
                    ></v-img>
                  </v-card>
                </v-col>
                <v-col align="start" cols="6">
                  <p
                    ...
                    v-if="brand.name"
                  >
                    {{ brand.mobileSpotlightImage }}
                  </p>
                </v-col>
                <v-col class="btnX" align="end" cols="1">
                  <v-btn v-if="brand.mobileSpotlightImage" text fab small>
                    <v-icon small>mdi-delete</v-icon>
                  </v-btn>
                </v-col>
              </v-row>
